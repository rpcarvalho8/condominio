 ...
 *
 * Execute com (a partir de packages/web para o Bun ler o .env local):
 *   cd packages/web && bun ../../migration-clean.ts
 *
 * Ou passando as variáveis manualmente:
 *   DATABASE_URL=libsql://... DATABASE_AUTH_TOKEN=... bun migration-clean.ts
 *
...
if (!DATABASE_URL) {
  ...
  console.error("  Executa a partir de packages/web (onde existe o .env):");
  console.error("    cd packages/web && bun ../../migration-clean.ts");
  process.exit(1);
}
